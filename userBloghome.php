...
$query = "SELECT user_blogs.*, user.first_name, user.last_name,profile_picture
FROM user_blogs
...
<div class="createPost">
   ...
   <div class="blogHome">
      ...
      while($row = mysqli_fetch_assoc($result)):
         ...
         echo '<h5><img src="' . $row['profile_picture'] . '" alt="Profile Picture" class="round-image"> ' . $row['first_name'] . ' ' . $row['last_name'] . '</h5>';
         ...
         $blogId = $row['blog_id'];
         $commentQuery = "SELECT user_blog_comments.*, user.first_name,user.last_name,user.profile_picture
